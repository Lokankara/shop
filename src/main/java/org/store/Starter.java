...
//
//        JdbcProductTemplate jdbcProductTemplate = new JdbcProductTemplate();
...
//        contextHandler.addServlet(new ServletHolder(new CartServlet(productService)), "/products/cart/*");
